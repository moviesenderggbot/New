...
# MongoDB information
DATABASE_URI = environ.get('DATABASE_URI', "mongodb+srv://fakave7698:vUjf8bPQGPanrLH7@cluster0.crtwuc0.mongodb.net/?retryWrites=true&w=majority&appName=Cluster0")
DATABASE_NAME = environ.get('DATABASE_NAME', "fakave7698")
COLLECTION_NAME = environ.get('COLLECTION_NAME', 'Telegram_files')

# Verify
VERIFY = bool(environ.get('VERIFY', False)) # Verification On ( True ) / Off ( False )
HOWTOVERIFY = environ.get('HOWTOVERIFY', 'https://telegram.dog/+77D2AejU4eU0NDI1') # How to open tutorial link for verification
# Others
...
CHNL_LNK = environ.get('CHNL_LNK', 'https://t.me/moiveadmin')
TUTORIAL = environ.get('TUTORIAL', 'https://t.me/moiveadmin') # Tutorial video link for opening shortlink website 
...
SUPPORT_CHAT = environ.get('SUPPORT_CHAT', 'https://t.me/moiveadminsupport') #Support group link ( make sure bot is admin )
...
FQDN = str(getenv('FQDN', BIND_ADRESS)) if not ON_HEROKU or getenv('FQDN') else 'moviesenderggbot-735f44fb1a2c.herokuapp.com'
